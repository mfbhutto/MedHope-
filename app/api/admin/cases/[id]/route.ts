// API Route: GET /api/admin/cases/[id]
// Get a single case by ID (admin only)
...
export async function GET(
  ...
  try {
    ...
    const caseData = {
      ...
      volunteerId: (needyPerson as any).volunteerId?.toString(),
      volunteerApprovalStatus: (needyPerson as any).volunteerApprovalStatus,
      volunteerRejectionReasons: (needyPerson as any).volunteerRejectionReasons || [],
